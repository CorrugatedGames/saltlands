...
public class SaltLandsWorld : IDisposable
{
    ...
    {
        Generator.GenerateAroundCenter(Settings.MagicNumbers.MapSizeX / Settings.MagicNumbers.ChunkSize, Settings.MagicNumbers.MapSizeY / Settings.MagicNumbers.ChunkSize, 25);
